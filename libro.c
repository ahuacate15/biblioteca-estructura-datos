...
Arbol *cargarRegistrosDefecto(Arbol *arbol, ListaSede *listaSede) {
	...
	libro1->genero = "Literatura contempor�nea";
	libro1->copias = 0;
	libro1->year = 1990;
    ...
    libro6->autor = "Jorge Garc�a Garc�a";
    libro6->genero = "Novela polic�aca";
    libro6->copias = 0;
    libro6->year = 2020;
    ...
    libro7->genero = "Novela hist�rica";
    libro7->copias = 0;
    libro7->year = 2020;
    ...
    libro9->genero = "Poes�a y prosa po�tica ilustrada";
    libro9->copias = 0;
    libro9->year = 2019;
    ...
    libro12->genero = "Novela post-apocal�ptica";
    libro12->copias = 0;
    libro12->year = 2016;
    ...
    libro13->genero = "Novela rom�ntica";
    libro13->copias = 0;
    libro13->year = 2003;
    ...
    libro14->titulo = "Cien a�os de soledad";
    libro14->isbn = "9786070704031";
    libro14->autor = "Gabriel Garc�a M�rquez";
    libro14->genero = "Realismo m�gico";
    libro14->copias = 0;
    libro14->year = 1967;
    ...
    libro15->genero = "Novela contempor�nea";
    libro15->copias = 0;
    libro15->year = 2002;
    ...
    libro16->genero = "Novela hist�rica";
    libro16->copias = 0;
    libro16->year = 1850;
    ...
    libro17->genero = "Novela hist�rica";
    libro17->copias = 0;
    libro17->year = 1989;
    ...
    libro18->titulo = "Juego de tronos: Canci�n de Hielo y Fuego";
    libro18->isbn = "9786073128834";
    libro18->autor = "George R.R. Martin";
    libro18->genero = "Fantas�a heroica";
    libro18->copias = 0;
    libro18->year = 1996;
    ...
    libro21->genero = "Literatura fant�stica";
    libro21->copias = 0;
    libro21->year = 1865;
    ...
    libro24->genero = "Literatura contempor�nea";
    libro24->copias = 0;
    libro24->year = 1982;
    ...
    libro28->autor = "Antoine de Saint-Exup�ry";
    libro28->genero = "Novela filos�fica";
    libro28->copias = 0;
    libro28->year = 1951;
    ...
    libro30->genero = "Literatura fant�stica";
    libro30->copias = 0;
    libro30->year = 1997;
    ...
    libro31->genero = "Literatura fant�stica";
    libro31->copias = 0;
    libro31->year = 1954;
    ...
    libro32->genero = "Novela rom�ntica";
    libro32->copias = 0;
    libro32->year = 1813;
